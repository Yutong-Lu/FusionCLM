...
split1_X_valid2 <- as.matrix(read.csv('../split_1/processed_data/delaney_X_ensemble_valid2_scaled_rawpreds.csv'))
split1_y_valid2 <- as.matrix(read.csv('../split_1/processed_data/delaney_y_ensemble_valid2.csv'))

split1_X_test <- as.matrix(read.csv('../split_1/processed_data/delaney_X_ensemble_test_scaled_rawpreds.csv'))
split1_y_test <- as.matrix(read.csv('../split_1/processed_data/delaney_y_ensemble_test.csv'))
...
split2_X_valid2 <- as.matrix(read.csv('../split_2/processed_data/delaney_X_ensemble_valid2_scaled_rawpreds.csv'))
split2_y_valid2 <- as.matrix(read.csv('../split_2/processed_data/delaney_y_ensemble_valid2.csv'))

split2_X_test <- as.matrix(read.csv('../split_2/processed_data/delaney_X_ensemble_test_scaled_rawpreds.csv'))
split2_y_test <- as.matrix(read.csv('../split_2/processed_data/delaney_y_ensemble_test.csv'))
...
split3_X_valid2 <- as.matrix(read.csv('../split_3/processed_data/delaney_X_ensemble_valid2_scaled_rawpreds.csv'))
split3_y_valid2 <- as.matrix(read.csv('../split_3/processed_data/delaney_y_ensemble_valid2.csv'))

split3_X_test <- as.matrix(read.csv('../split_3/processed_data/delaney_X_ensemble_test_scaled_rawpreds.csv'))
split3_y_test <- as.matrix(read.csv('../split_3/processed_data/delaney_y_ensemble_test.csv'))
