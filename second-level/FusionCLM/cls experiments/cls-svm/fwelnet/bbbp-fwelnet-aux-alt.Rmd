...
split1_X_valid2 <- as.matrix(read.csv('../split_1/processed_data/bbbp_X_ensemble_valid2_scaled_aux_alt.csv'))
split1_y_valid2 <- as.matrix(read.csv('../split_1/processed_data/bbbp_y_ensemble_valid2.csv'))

split1_X_test <- as.matrix(read.csv('../split_1/processed_data/bbbp_X_ensemble_test_scaled_aux_alt.csv'))
...
split2_X_valid2 <- as.matrix(read.csv('../split_2/processed_data/bbbp_X_ensemble_valid2_scaled_aux_alt.csv'))
split2_y_valid2 <- as.matrix(read.csv('../split_2/processed_data/bbbp_y_ensemble_valid2.csv'))

split2_X_test <- as.matrix(read.csv('../split_2/processed_data/bbbp_X_ensemble_test_scaled_aux_alt.csv'))
...
pred_factor <- factor(ifelse(split2_preds_test2 >= 0.5, 1, 0), levels = c(0, 1))
true_factor <- factor(split2_y_test, levels = c(0, 1))
...
# Calculate Accuracy and F1 Score
# Convert predictions and true labels to factors
pred_factor <- factor(ifelse(split2_preds_test4 >= 0.5, 1, 0), levels = c(0, 1))
true_factor <- factor(split2_y_test, levels = c(0, 1))
...
split3_X_valid2 <- as.matrix(read.csv('../split_3/processed_data/bbbp_X_ensemble_valid2_scaled_aux.csv'))
split3_y_valid2 <- as.matrix(read.csv('../split_3/processed_data/bbbp_y_ensemble_valid2.csv'))

split3_X_test <- as.matrix(read.csv('../split_3/processed_data/bbbp_X_ensemble_test_scaled_aux.csv'))
