...
chemberta2_pred <- read.csv('./processed_data/delaney_chemberta_pred.csv')
molformer_pred <- read.csv('./processed_data/delaney_molformer_pred.csv')
molbert_pred <- read.csv('./processed_data/delaney_molbert_pred.csv')

# Load the scaled feature datasets for auxiliary models
chemberta_X_scaled <- as.matrix(read.csv('./processed_data/delaney_chemberta_X.csv'))
molformer_X_scaled <- as.matrix(read.csv('./processed_data/delaney_molformer_X.csv'))
molbert_X_scaled <- as.matrix(read.csv('./processed_data/delaney_molbert_X.csv'))

# Load the target (y) datasets
chemberta_y_residual <- as.matrix(read.csv('./processed_data/delaney_chemberta_y.csv'))
molformer_y_residual <- as.matrix(read.csv('./processed_data/delaney_molformer_y.csv'))
molbert_y_residual <- as.matrix(read.csv('./processed_data/delaney_molbert_y.csv'))

y_ensemble_valid2 <- as.matrix(read.csv('./processed_data/delaney_y_ensemble_valid2.csv'))
...
chemberta2_pred_test <- read.csv('./processed_data/delaney_chemberta_pred_test.csv')
molformer_pred_test <- read.csv('./processed_data/delaney_molformer_pred_test.csv')
molbert_pred_test <- read.csv('./processed_data/delaney_molbert_pred_test.csv')

# Load the scaled test datasets
chemberta_X_test_scaled <- as.matrix(read.csv('./processed_data/delaney_chemberta_X_test.csv'))
molformer_X_test_scaled <- as.matrix(read.csv('./processed_data/delaney_molformer_X_test.csv'))
molbert_X_test_scaled <- as.matrix(read.csv('./processed_data/delaney_molbert_X_test.csv'))

# Optional for eval
y_ensemble_test <- as.matrix(read.csv('./processed_data/delaney_y_ensemble_test.csv'))
```
...
write.csv(results, file = "./split3_delaney_metrics_fwelnet.csv", row.names = FALSE)
```

```{r}
# pred_vs_true <- data.frame(
#   pred = pred_test22,
#   chemberta_pred = chemberta2_pred_test_raw,
#   molformer_pred = molformer_pred_test_raw,
#   molbert_pred = molbert_pred_test_raw,
#   true = y_ensemble_test
# )
# 
# write.csv(pred_vs_true, file = "./split3_delaney_results_fwelnet.csv", row.names = FALSE)
```
