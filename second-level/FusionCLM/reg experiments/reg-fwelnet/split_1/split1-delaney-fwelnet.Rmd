...
write.csv(results, file = "./split1_delaney_metrics_fwelnet.csv", row.names = FALSE)
```
...
# )
# 
# write.csv(pred_vs_true, file = "./split1_delaney_results_fwelnet.csv", row.names = FALSE)
```
