...
# Load the dataset
train_df = pd.read_csv("train_lipo.csv")
valid2_df = pd.read_csv("valid2_lipo.csv")
valid_df = pd.read_csv("valid_lipo.csv")
test_df = pd.read_csv("test_lipo.csv")
...
training_args = TrainingArguments(
    ...
    save_strategy="epoch",
    logging_dir="./lipo-tf-output/logs",
...
csv_file_path = './chemberta2_valid2_lipo_predictions.csv'
...
# Saving the DataFrame with the correct column names to a new CSV file
csv_file_path = './chemberta2_test_lipo_predictions.csv'
df.to_csv(csv_file_path, index=False)
print(f"Successfully saved to {csv_file_path}")
