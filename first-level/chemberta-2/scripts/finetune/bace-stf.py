...
# from deepchem.molnet import load_bbbp, load_clearance, load_bace, load_delaney, load_hiv, load_qm7, load_tox21
...
train_df = pd.read_csv("train_bace.csv")

valid_df = pd.read_csv("valid_bace.csv")

valid2_df = pd.read_csv("valid2_bace.csv")

test_df = pd.read_csv("test_bace.csv")

# set the logging directories
project_name = "chemberta-2-bace-stf"
output_path = './bace-stf-output'
model_name = "77m-MTR"
...
EPOCHS = 100
BATCH_SIZE = 64
learning_rate = 2.316207637558977e-05
weight_decay = 0.001
...
valid2_predictions_df_path = os.path.join(evaluation_folder, 'chemberta2_valid2_bace_predictions.csv')
valid2_predictions_df.to_csv(valid2_predictions_df_path)

print(f"Chemberta-2 bace valid2 predictions saved to {valid2_predictions_df_path}")
...
test_predictions_df_path = os.path.join(evaluation_folder, 'chemberta2_test_bace_predictions.csv')
test_predictions_df.to_csv(test_predictions_df_path)

print(f"Chemberta-2 bace test predictions saved to {test_predictions_df_path}")
